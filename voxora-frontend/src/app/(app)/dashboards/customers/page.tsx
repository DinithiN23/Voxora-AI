...
/**
 * Voxora AI — Customer Intelligence & Lifetime Value Dashboard Page.
 *
 * Route: /dashboards/customers
 * Customer tier segmentation, retention health, account leaderboard, and CLV.
 */
    ...
    <div className={styles.dashboardPage}>
      ...
      <div className={styles.dashboardHeader}>
        <div className={styles.headerLeft}>
          <h1 className={styles.pageTitle}>Customer Intelligence & LTV</h1>
