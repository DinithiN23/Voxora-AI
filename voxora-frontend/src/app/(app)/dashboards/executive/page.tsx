...
/**
 * Voxora AI — Executive Overview Dashboard Page.
 *
 * Route: /dashboards/executive
 * Macro corporate performance, 2-year profit margins, and board-level KPIs.
 */
      ...
      <div className={styles.dashboardHeader}>
        <div className={styles.headerLeft}>
          ...
          <p className={styles.pageSubtitle}>
            High-level business health, 2-year profit margins, and macro corporate trajectory
          </p>
        </div>
